...
def prepare_data(images):
    ...
    for i, image_file in enumerate(images):
        ...
        if 'spoof' in image_file.lower():
            y[0, i] = 1
        elif 'bonafide' in image_file.lower():
            y[0, i] = 0
    return X, y
...
def ResNet50(input_shape = (ROWS, COLS, CHANNELS), classes = 2):   
...
model.fit(X_train, Y_train, validation_data=(X_test, Y_test), epochs=11, batch_size=32)
